...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <a [routerLink]="'/events/' + event.id" class="group relative bg-surface-container-lowest rounded-xl overflow-hidden transition-all duration-300 hover:-translate-y-2 block">
      <!-- Image Section -->
