...
> ⚠️ **IMPORTANTE:** Estas credenciales son **SOLO para desarrollo local**. En producción, cambia las contraseñas en el archivo `.env.prod` o exporta las variables de entorno antes de desplegar.
